...
public class ExcelReader {
	...
	public static void main(String args[]) {
		...
		try {
			sc = new Scanner(new FileInputStream("/Users/agiamatti/Desktop/Music1.txt"));
			pw1 = new PrintWriter(new FileOutputStream("/Users/agiamatti/Desktop/Music_Artist.txt"));
			pw2 = new PrintWriter(new FileOutputStream("/Users/agiamatti/Desktop/Music_Albums.txt"));
			pw3 = new PrintWriter(new FileOutputStream("/Users/agiamatti/Desktop/Music_Misc.txt"));
		} catch (FileNotFoundException ioe) {
			System.out.println("Error with sc/pw. Shutting down.");
			System.exit(0);
		}

		analyzeFile(sc, pw1, pw2, pw3);
		sc.close();
		pw1.close();
		pw2.close();
		pw3.close();
